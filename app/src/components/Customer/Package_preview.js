...
export default function Package_preview() {
  ...
  let { id } = useParams();
  const [package1, setPackag1] = useState([
    {
      name: "Rajasthan",
      pacdetails:
    ...
    },
    {
      name: "Goa",
      pacdetails:
        "Goa is a state in southern India. It covers 342,239 square kilometres or 10.4 percent of India's total geographical area. It is the largest Indian state by area and the seventh largest by population.",
      price: "5000",
      status: "drafts",
      days: "5",
      nights: "4",
    ...
    <div>
      ...
      <div className="d-flex m-4">
        ...
        <div className="col-4 p-4 m-4">
          ...
          <hr />
          <p>
            <b>Destination</b> : {package1[id].name}
            <hr />
            <b>Details</b> : {package1[id].pacdetails}
            <hr /> <b>Price : </b> {package1[id].price}
